...
import { GAME_STATES, GAME_ACTIONS, calculateHandValue } from './blackjackCore';
        ...
        case GAME_ACTIONS.BET:
          ...
          if (data.handComplete) {
            sendMessage('playerAction', {
              type: GAME_ACTIONS.DEALER_COMPLETE
            });
          }
          break;
